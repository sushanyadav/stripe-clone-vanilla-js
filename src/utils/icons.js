...
export const PaymentsIcon = () => {
  return `<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 md:w-8 md:h-8" viewBox="0 0 40 40"><path fill="url(#product-icon-payments-SiteMenu-a)" d="M34.61 11.28a2.56 2.56 0 00-1.22-1.04L8.54.2A2.57 2.57 0 005 2.6V15c0 1.05.64 2 1.61 2.4l6.44 2.6 21.56 8.72c.26-.4.4-.88.39-1.36V12.64c0-.48-.13-.96-.39-1.37z"></path><path fill="#96F" d="M34.63 11.28L13.06 20l-6.45 2.6A2.58 2.58 0 005 25v12.42a2.58 2.58 0 003.54 2.39L33.4 29.76c.5-.21.93-.57 1.21-1.04.26-.41.4-.88.39-1.36V12.64c0-.48-.12-.95-.37-1.36z"></path><path fill="url(#product-icon-payments-SiteMenu-b)" d="M34.62 11.28l.1.17c.18.37.28.77.28 1.19v-.03 14.75c0 .48-.13.95-.39 1.36L13.06 20l21.56-8.72z"></path><defs><linearGradient id="product-icon-payments-SiteMenu-a" x1="20" x2="20" y1="4.13" y2="21.13" gradientUnits="userSpaceOnUse"><stop stop-color="#11EFE3"></stop><stop offset="1" stop-color="#21CFE0"></stop></linearGradient><linearGradient id="product-icon-payments-SiteMenu-b" x1="35" x2="35" y1="11.28" y2="28.72" gradientUnits="userSpaceOnUse"><stop stop-color="#0048E5"></stop><stop offset="1" stop-color="#9B66FF"></stop></linearGradient></defs></svg>
 `;
};
...
export const EcommerceIcon = () => {
  return `
    <svg
      ...
      width="16"
      height="16"
      class="fill-current text-gray-500 group-hover:text-gray-900 mt-0 md:mt-1"
      view-box="0 0 16 16"
    >
      <path
        fillRule="evenodd"
